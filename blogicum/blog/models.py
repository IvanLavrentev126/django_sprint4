...
class Post(models.Model):
    ...
    def comment_count(self):
        return self.comments.count()  # фиксит эту ошибку. AssertionError:
        # Убедитесь, что на главной странице под постами отображается
        # количество комментариев. Число комментариев должно быть
...
class Comments(models.Model):
    ...
    @property
    def post_id(self):
        return self.current_post.id  # фиксит эту ошибку. AssertionError:
        # Убедитесь, что в контекст шаблонов страниц удаления и
        # редактирования комментария передаётся объект комментария.
